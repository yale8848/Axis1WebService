 ...
 */
    ...
    public MobileCodeWSSoap getMobileCodeWSSoap() throws javax.xml.rpc.ServiceException {
    ...
    public MobileCodeWSSoap getMobileCodeWSSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
    ...
    public MobileCodeWSSoap getMobileCodeWSSoap12() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public MobileCodeWSSoap getMobileCodeWSSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            cn.com.WebXml.MobileCodeWSSoap12Stub _stub = new cn.com.WebXml.MobileCodeWSSoap12Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (MobileCodeWSSoap.class.isAssignableFrom(serviceEndpointInterface)) {
            ...
            if (MobileCodeWSSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                cn.com.WebXml.MobileCodeWSSoap12Stub _stub = new cn.com.WebXml.MobileCodeWSSoap12Stub(new java.net.URL(MobileCodeWSSoap12_address), this);
                _stub.setPortName(getMobileCodeWSSoap12WSDDServiceName());
                return _stub;
            }
        }
