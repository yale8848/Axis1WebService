/**
 * MobileCodeWSSoap12Skeleton.java
 *
...
public class MobileCodeWSSoap12Skeleton implements MobileCodeWSSoap, org.apache.axis.wsdl.Skeleton {
    ...
    */
    ...
    public MobileCodeWSSoap12Skeleton() {
        this.impl = new MobileCodeWSSoap12Impl();
    }

    public MobileCodeWSSoap12Skeleton(MobileCodeWSSoap impl) {
        this.impl = impl;
    }
